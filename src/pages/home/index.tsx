        ...
        <div>
            <Section className={styles.hero} innerClassName={styles.heroContent}>
                ...
                <p>
                    ...
                    сервису, чтобы предложить желающим арендовать её.
                </p>
                <p>
            ...
            <Section id="social">
                ...
                <p>
                    ...
                    основа для сообщества: от поиска единомышленников до обмена опытом.
                </p>
                <p>
                    На одних и тех же книгах строятся профессиональные сообщества и компании друзей.
                </p>
            </Section>
        </div>
    );
